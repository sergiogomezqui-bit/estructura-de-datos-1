...
- `index.js` — servidor Express, rutas `GET/POST /prestamos`
- `scripts/utils.js` — cálculo de la cuota, formato de salida y generación de la página HTML
- `tests/utils.test.js` — pruebas del cálculo y del formato de salida (con el runner nativo de Node)
